...
BuildV2PubSub _$BuildV2PubSubFromJson(Map<String, dynamic> json) =>
    BuildV2PubSub(
      ...
      buildLargeFields: _$JsonConverterFromJson<String, String>(
          json['buildLargeFields'], const Base64Converter().fromJson),
      compression:
...
Map<String, dynamic> _$BuildV2PubSubToJson(BuildV2PubSub instance) {
  ...
  writeNotNull(
      ...
      _$JsonConverterToJson<String, String>(
          instance.buildLargeFields, const Base64Converter().toJson));
