...
void main() {
  group(
    'Check CheckPullRequest',
    () {
      late CollectPullRequestsHandler collectPullRequestsHandler;
      ...
      test('Multiple identical messages are processed once', () async {
        ...
        collectPullRequestsHandler = CollectPullRequestsHandler(
          config: config,
          pubsub: pubsub,
        ...
        await collectPullRequestsHandler.get();
      ...
      test('All messages are pulled', () async {
        ...
        cocoonRequest = PullRequestHelper(prNumber: 0, lastCommitHash: oid);
        final List<pub.ReceivedMessage> messages = await collectPullRequestsHandler.pullMessages();
